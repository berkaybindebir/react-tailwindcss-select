...
const DisabledItem = ({ children }) => {
    ...
    return (React__default["default"].createElement("div", { className: twMerge("px-2 py-2 cursor-not-allowed truncate text-gray-400 select-none", classNames?.listDisabledItem) }, children));
};
...
const GroupItem = ({ item, primaryColor }) => {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null, item.options.length > 0 && (React__default["default"].createElement(React__default["default"].Fragment, null,
        formatGroupLabel ? (React__default["default"].createElement(React__default["default"].Fragment, null, formatGroupLabel(item))) : (React__default["default"].createElement("div", { className: twMerge("pr-2 py-2 cursor-default select-none truncate font-bold text-gray-700", classNames?.listGroupLabel) }, item.label)),
...
const Options = ({ list, noOptionsMessage, text, isMultiple, value, primaryColor = DEFAULT_THEME }) => {
    ...
    return (React__default["default"].createElement("div", { role: "options", className: twMerge("max-h-72 overflow-y-auto", classNames?.list) },
...
const SearchInput = React.forwardRef(function SearchInput({ placeholder = "", value = "", onChange, name = "" }, ref) {
    const { classNames } = React.useContext(SelectContext);
    return (React__default["default"].createElement("div", { className: twMerge("relative py-1 px-2.5", classNames?.searchContainer) },
        React__default["default"].createElement(SearchIcon, { className: twMerge("absolute w-5 h-5 mt-2.5 pb-0.5 ml-2 text-gray-500", classNames?.searchIcon) }),
        React__default["default"].createElement("input", { ref: ref, className: twMerge("w-full py-2 pl-8 text-sm text-gray-500 bg-gray-100 border border-gray-200 rounded focus:border-gray-200 focus:ring-0 focus:outline-none", classNames?.searchBox), type: "text", placeholder: placeholder, value: value, onChange: onChange, name: name })));
});
...
const Select = ({ options = [], value = null, onChange, onSearchInputChange, placeholder = "Select...", searchInputPlaceholder = "Search...", isMultiple = false, isClearable = false, isSearchable = false, isDisabled = false, loading = false, menuIsOpen = false, noOptionsMessage = "No options found", primaryColor = DEFAULT_THEME, formatGroupLabel = null, formatOptionLabel = null, classNames }) => {
    ...
    return (React__default["default"].createElement(SelectProvider, { otherData: {
        ...
        React__default["default"].createElement("div", { className: "relative w-full", ref: ref },
            React__default["default"].createElement("div", { "aria-expanded": open, onKeyDown: onPressEnterOrSpace, onClick: toggle, className: getSelectClass() },
                React__default["default"].createElement("div", { className: "grow pl-2.5 py-2 pr-2 flex flex-wrap gap-1" }, !isMultiple ? (React__default["default"].createElement("p", { className: "truncate cursor-default select-none" }, value && !Array.isArray(value) ? value.label : placeholder)) : (React__default["default"].createElement(React__default["default"].Fragment, null,
                    ...
                    Array.isArray(value) &&
                        value.map((item, index) => (React__default["default"].createElement("div", { className: getTagItemClass(item), key: index },
                            React__default["default"].createElement("p", { className: twMerge("text-gray-600 truncate cursor-default select-none", classNames?.tagItemText) }, item.label),
                            !isDisabled && (React__default["default"].createElement("div", { role: "button", tabIndex: 0, onClick: e => removeItem(e, item), className: twMerge("flex items-center px-1 cursor-pointer rounded-r-sm hover:bg-red-200 hover:text-red-600", classNames?.tagItemIconContainer) },
                                React__default["default"].createElement(CloseIcon, { className: twMerge("w-3 h-3 mt-0.5", classNames?.tagItemIcon) }))))))))),
                React__default["default"].createElement("div", { className: "flex flex-none items-center py-1.5" },
                    ...
                    isClearable && !isDisabled && value !== null && (React__default["default"].createElement("div", { className: "px-1.5 cursor-pointer", onClick: clearValue },
                        React__default["default"].createElement(CloseIcon, { className: twMerge("w-5 h-5 p-0.5", classNames?.closeIcon) }))),
            ...
            open && !isDisabled && (React__default["default"].createElement("div", { className: twMerge("absolute z-10 w-full bg-white shadow-lg border rounded py-1 mt-1.5 text-sm text-gray-700", classNames?.menu) },
